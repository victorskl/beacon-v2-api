...
public class BeaconMaturityAttributes {
    
    private String production_status;
    private String security_attributes;
    
    public String getProductionStatus() {
        return production_status;
    }
    
    public void setProductionStatus(String production_status) {
    ...
    public void setSecurityAttributes(String security_attributes) {
