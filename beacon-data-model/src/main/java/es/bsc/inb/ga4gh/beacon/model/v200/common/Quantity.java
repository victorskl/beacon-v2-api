 ...
 * @param <L> ReferenceRange implementation class
 */

public interface Quantity<K extends OntologyTerm, L extends ReferenceRange>
        extends Value {
    ...
    L getReferenceRange();
    void setReferenceRange(L referenceRange);
}
